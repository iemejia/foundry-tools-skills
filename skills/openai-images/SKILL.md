...
- For Azure OpenAI: a resource with a deployed image model (gpt-image-2
  available in East US 2, West US 3, Sweden Central, Poland Central, UAE North).
- Python ≥ 3.8.
...
**OpenAI (gpt-image-2 — recommended):**
